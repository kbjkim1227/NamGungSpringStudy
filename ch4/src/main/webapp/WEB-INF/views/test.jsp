    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            $("#modBtn").click(function(){
                ...
                $.ajax({
                    type:'PATCH',       // 요청 메서드
                    url: '/ch4/comments/'+cno,  // 요청 URI    //  /ch4/comments?bno=2029 POST <- 컨트롤러에 있는 url 참조해서.
            ...
            $("#wrtRepBtn").click(function(){
                ...
                $.ajax({
                    type:'POST',       // 요청 메서드
                    url: '/ch4/comments?bno='+bno,  // 요청 URI    //  /ch4/comments?bno=2029 POST <- 컨트롤러에 있는 url 참조해서.
                    headers : { "content-type": "application/json"}, // 요청 헤더
            ...
            // $(".delBtn").click(function(){ <- 요렇게 하면 인식 안 된다.
            $("#commentList").on("click", ".delBtn", function(){    // <- 이렇게 해줘야 함.
                let cno = $(this).parent().attr("data-cno");
